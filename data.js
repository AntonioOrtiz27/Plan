...
const ROUTINE = [
  {
    ...
    categoria: "pitch",
    ejercicios: [
      { chip: "35'", texto: "Caminata + trote suave, ritmo conversación" },
      { chip: "~7:50/km", texto: "ritmo de referencia, según tu última salida" },
      { chip: "5'", texto: "elongación general al cierre" }
    ],
  ...
  },
  {
    ...
    categoria: "pitch",
    ejercicios: [
      { chip: "35'", texto: "trote continuo, ritmo algo más firme" },
      { chip: "~8:00/km", texto: "· FC ~160 ppm, según tu última salida" }
    ],
    nota: "35' es el tiempo que querés poder rendir en un tiempo de fútbol."
  },
  {
    id: "jueves",
    nombre: "JUEVES",
  ...
  },
  {
    ...
    titulo: "Descanso",
    categoria: "rest",
    descanso: "Sin entrenamiento — previa del partido. Dormí bien e hidratate para llegar con las piernas frescas al sábado."
  },
  {
    id: "sabado",
    nombre: "SÁBADO",
